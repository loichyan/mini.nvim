...
-- Set a high contrast highlight for floatings.
-- Though normally only background color is slightly different.
vim.api.nvim_set_hl(0, 'NormalFloat', { fg = 'red', bg = 'green' })
